...
```bash
git clone https://github.com/actionanand/converter.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/converter#1-skeleton angular-proj-name
```
